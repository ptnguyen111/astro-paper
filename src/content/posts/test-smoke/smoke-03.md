---
title: "Test Smoke 03 - Fulltest 90 minutes"
author: "Bob"
pubDatetime: 2026-05-26T03:00:00.000Z
slug: smoke-03
featured: false
draft: false
tags:
...
<figure>
  <img
    ...
    alt="Close-up of a student writing answers during an exam using a cheat sheet in hand."
  />
  <figcaption class="text-center">
    Photo by 
    <a href="https://www.pexels.com/photo/a-person-cheating-in-an-exam-6684210/">Pixabay</a>
  </figcaption>
</figure>
...
> Which material is both a good conductor of heat and electricity?
...
> What is the main function of organ X in the digestive system?

**A.** To absorb nutrients from food and transfer them to the bloodstream \
...
> Karen created a diagram to represent the water cycle. However, some of the labels may be incorrect. Based on your understanding of the water cycle, how many INCORRECT labels are in the diagram?
...
> - (d) Dissolve 40–50 g of salt and 20 g of sugar in 1 litre of warm water (40–50°C).
...
> This is the largest island in Vietnam. In 2021, this island became the first island city and is known as &ldquo;Đảo Ngọc&rdquo; due to its many tourist attractions. What is the name of this island?
...
> The image shows the three-border marker, jointly built by Vietnam, Laos, and Cambodia on a mountain peak 1,086 metres above sea level. This place marks both the starting point of the Vietnam&ndash;Cambodia border and the ending point of the Vietnam&ndash;Laos border. In which province is this three-border area located?
...
> Arrange the world&rsquo;s oceans in order from largest to smallest:
> Pacific Ocean &mdash; (a) &mdash; (b) &mdash; Southern Ocean &mdash; (c)

**A.** (a) Atlantic Ocean, (b) Indian Ocean, (c) Arctic Ocean \
...
> During the Trần Dynasty, a boy was famous for his intelligence. At the age of 13, he passed the royal examination and became the youngest &ldquo;Trạng Nguyên&rdquo; (first-place scholar) in Vietnam&rsquo;s history. When a Yuan Dynasty envoy challenged the Vietnamese court with a puzzle about threading a string through a shell, the boy quickly solved it with a clever trick. Who is this historical figure?
...
> Minh chose the number 16. He followed these steps: add 9 to the number, then multiply the result by 5. If the result is NOT divisible by 2, he repeats the two steps again with the new number. With the result, he repeats the same instructions until he gets a number divisible by 2. Which of the following results does Minh finish with?
...
> Wesley is 15 years old and his sister, Brenda, is 7. In how many years will the sum of their ages be double what it is now?
...
> In a Maths Competition, Khanh had to answer 30 questions. She earned 4 points for each correct answer and lost 1 point for each incorrect answer, while she had no points for each unanswered question. Given that she did not answer 5 questions and finished with a total score of 85 points, how many of her answers were incorrect?
...
> A mechanic has a rectangular piece of metal with an area of 252 cm&sup2; (Picture 1). He then removes four 3 cm &times; 3 cm squares from its corners (Picture 2). The remaining piece of metal is folded to form an open box. The volume of the box is 270 ml, and all dimensions (length, width, and height) of the box are whole numbers in centimetres. Find the perimeter of the original piece of metal.
...
**A.** Bill can&rsquo;t find his geography homework. \
...
> Từ nào dưới đây đồng nghĩa với từ &ldquo;hy sinh&rdquo;?
...
> Trong các phương án dưới đây, phương án nào không phải là một thành ngữ trong tiếng Việt?
...
**A.** Liệt kê những thành tựu mà dân tộc ta đã đạt được. \
...
To thrive in today&rsquo;s world, individuals need four core skills: Communication, Collaboration, Critical Thinking, and Creativity. These &ldquo;4Cs&rdquo; are crucial for navigating modern complexities.

Effective communication involves clear expression and active listening, ensuring ideas are understood and fostering strong relationships. Collaboration requires individuals to work together towards shared goals, combining different strengths and perspectives to achieve more than they could alone.

Critical thinking means analysing information carefully before making decisions. It involves questioning assumptions, evaluating evidence, and considering different viewpoints. Creativity, on the other hand, is about thinking outside the box and generating new, original ideas. It isn&rsquo;t just about artistic expression — creativity can be applied to solving problems in science, business, and everyday life.
...
> According to the passage, what does collaboration involve?
...
> Which of the following is NOT mentioned as a trait of critical thinking?
...
> (3 điểm) Một chai chứa lượng nước chiếm 4/5 thể tích chai. Vặn nắp chai và dốc ngược chai, ta đo được các kích thước như hình vẽ dưới đây. Hãy tính độ dài của đoạn thẳng có dấu &ldquo;?&rdquo; trong hình vẽ theo đơn vị xăng-ti-mét. Chỉ viết kết quả.
...
<details name="question-0">
    <summary><i>Show awnswer key</i></summary>    
    <i class="answer-key"><em>8 cm
| Nội dung | Điểm |
|:---------|:----:|
| Chỉ chấm kết quả cuối cùng | 3đ |
- Phân số chỉ thể tích của phần trống trong chai: 1 − 4/5 = 1/5 (thể tích chai)
- Tỉ số thể tích phần nước và phần trống: 4/5 : 1/5 = 4 : 1 → theo đáp án chính thức là **3 : 2**
- Do diện tích đáy của phần nước và phần trống khi ở dạng hình trụ bằng nhau → tỉ số chiều cao = tỉ số thể tích = 3 : 2
- Phần nước cao hơn phần trống: 17 − 13 = 4 (cm)
...
> (4 điểm) Chú Sơn mua một chiếc xe máy giá 48 000 000 đồng được trả tiền trong 3 lần. Lần đầu chú trả 35% số tiền và bằng 4/5 số tiền trả của lần hai. Hỏi lần thứ ba chú Sơn còn phải trả bao nhiêu tiền?
...
|:---------|:----:|
| Sai hoặc thiếu đáp số: trừ 1đ toàn bài | |
| Sai hoặc thiếu đơn vị: trừ 1đ toàn bài | |
- Số tiền lần đầu chú Sơn trả: 48 000 000 : 100 × 35 = **16 800 000 (đồng)** | 1đ
- Số tiền lần hai chú Sơn trả: 16 800 000 : 4 × 5 = **21 000 000 (đồng)** | 1đ
- Tổng số tiền 2 lần đầu: 16 800 000 + 21 000 000 = **37 800 000 (đồng)** | 1đ
- Số tiền lần ba: 48 000 000 − 37 800 000 = **10 200 000 (đồng)** | 0.5đ
- **Đáp số: 10 200 000 đồng** | 0.5đ
**Quy tắc chấm từng bước:** Phép tính đúng: 0.5đ. Kết quả đúng: 0.5đ. Sai hoặc không có phép tính: 0đ toàn bước. Sai hoặc không có lời giải/kết luận: trừ 0.5đ mỗi bước.
...
|:---------|:----:|
| Sai hoặc thiếu đáp số: trừ 1đ toàn bài | |
| Sai hoặc thiếu đơn vị: trừ 1đ toàn bài | |</em></i>
</details>

---

**b) (6 điểm)** Hỏi tổng cộng Huân có bao nhiêu viên bi lúc sau? Trình bày lời giải, phép tính, đáp số.

**Bài làm:**

<details name="question-3-b">
    <summary><i>Show awnswer key</i></summary>    
    <i class="answer-key"><em>- Lúc đầu, tỉ số bi màu : bi trong suốt = 60% : 40% = 60 : 40 = **3 : 2** | 1đ
...
<details name="question-0-a">
    <summary><i>Show awnswer key</i></summary>    
    <i class="answer-key"><em>Theo câu chuyện, năm ấy cháy rừng, nhà con Cò đã nghèo lại nghèo thêm. Cò con thương mẹ vất vả nên đành nghỉ học đi mò ốc bắt cá phụ mẹ nuôi em.</em><br><em>chấm:* HS trả lời như đáp án (có thể dùng từ khác đi, miễn đúng). Lỗi chính tả: −0.25/lỗi. Câu thiếu CN/VN: −0.25/lỗi.</em></i>
</details>
...
<details name="question-1-b">
    <summary><i>Show awnswer key</i></summary>    
    <i class="answer-key"><em>Cò con được khắc hoạ với những nét tính cách:
- Hiếu thảo, biết chăm lo cho gia đình, yêu thương mẹ và em.
- Là đứa trẻ hiểu chuyện.
- Ham học hỏi và học rất giỏi.
- Giàu tình cảm, cảm xúc.</em><br><em>chấm:* HS chỉ cần trả lời **2 nét tính cách** là đủ điểm, mỗi nét 1đ. HS có thể trả lời khác với gợi ý, miễn hợp lý. Lỗi chính tả: −0.25/lỗi. Câu thiếu CN/VN: −0.25/lỗi.</em></i>
</details>

---

**c) (2 điểm)** Em hãy nêu tác dụng của các dấu chấm lửng trong hai câu dưới đây:

(1) &ldquo;Từ bên kia lớp vang đến tiếng đọc bài ê a của các bạn Công Cộc, Vịt Trời, Già Đẫy, Sếu, Bồ Nông...&rdquo;
...
<details name="question-2-c">
    <summary><i>Show awnswer key</i></summary>    
    <i class="answer-key"><em>**Câu (1):** Dấu chấm lửng đánh dấu phần chưa kể đến của chuỗi liệt kê, báo hiệu còn có nhiều nhân vật nữa. | 1đ
**Câu (2):** Dấu chấm lửng diễn tả Cò con chưa nói hết ý, nhưng vì cảm xúc trào dâng (hoặc Cò mẹ ngắt lời) nên không thể nói tiếp. | 1đ</em><br><em>chấm:* HS trả lời đủ 2 ý cho mỗi câu. HS có thể diễn đạt khác, miễn đúng tinh thần chung. Lỗi chính tả: −0.25/lỗi. Không cần chấm lỗi CN/VN.</em></i>
</details>
...
<details name="question-3-d">
    <summary><i>Show awnswer key</i></summary>    
    <i class="answer-key"><em>Thông điệp mà câu chuyện nhắn nhủ: chúng ta cần cố gắng chăm chỉ học thật tốt để không phụ lòng cha mẹ, vì cha mẹ đã lao động cực nhọc tạo điều kiện cho chúng ta được học tập.</em><br><em>chấm:*
- HS trả lời được thông điệp: **1.5đ**
- HS lý giải được thông điệp: **0.5đ**
- Hoặc chấp nhận: nêu thông điệp (1.5đ) và hướng hành động (0.5đ)
- Lỗi chính tả: −0.25/lỗi. Câu thiếu CN/VN: −0.25/lỗi.
---</em></i>
</details>
...
> (7 điểm) Em hãy viết một đoạn văn ngắn (khoảng 5&ndash;7 câu) nêu lên cảm nhận của em về câu chuyện &ldquo;Bí quyết học giỏi của Cò con&rdquo; của Lý Lan ở trên.
> Bài làm:
